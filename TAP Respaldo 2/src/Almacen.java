...
public class Almacen extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        //DOBLE Todos los ingredientes más doble carne.
        if (tipoh.equals("doble")) {
            ...
            int Queso = Integer.parseInt(tAlmacen.getValueAt(0, 4).toString()) - 1;
            datosA.setQueso(Queso);
            int Carne = Integer.parseInt(tAlmacen.getValueAt(0, 5).toString()) - 2;
            datosA.setCarne(Carne);

            actualizarAlmacen();
           // System.out.println("COMPRA " + tipoh + " " + datosA.pan + " " + datosA.queso + " " + datosA.lechuga + " " + datosA.tomate + " " + datosA.carne);
        }else
        //especia: todos los ingredientes con doble carne y queso
        if (tipoh.equals("especial")) {
            int Pan = Integer.parseInt(tAlmacen.getValueAt(0, 1).toString()) - 1;
            datosA.setPan(Pan * Integer.parseInt(cantidad));
            int Lechuga = Integer.parseInt(tAlmacen.getValueAt(0, 2).toString()) - 1;
            datosA.setLechuga(Lechuga);
            int Tomate = Integer.parseInt(tAlmacen.getValueAt(0, 3).toString()) - 1;
            datosA.setTomate(Tomate);
            int Queso = Integer.parseInt(tAlmacen.getValueAt(0, 4).toString()) - 2;
            datosA.setQueso(Queso);
            int Carne = Integer.parseInt(tAlmacen.getValueAt(0, 5).toString()) - 2;
            datosA.setCarne(Carne);
