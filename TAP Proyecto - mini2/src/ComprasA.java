...
public class ComprasA extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (tipoh.equals("especial")) {
            ...
            //------------------------------------
        } else if (minic.combo.equals(1)) {
            int Pan = Integer.parseInt(tAlmacen.getValueAt(0, 1).toString()) - (1);
            datosA.setPan(Pan);
            int Lechuga = Integer.parseInt(tAlmacen.getValueAt(0, 2).toString()) - (1);
            datosA.setLechuga(Lechuga);
            int Tomate = Integer.parseInt(tAlmacen.getValueAt(0, 3).toString()) - (1);
            datosA.setTomate(Tomate);
            int Queso = Integer.parseInt(tAlmacen.getValueAt(0, 4).toString()) - (1);
            datosA.setQueso(Queso);
            int Carne = Integer.parseInt(tAlmacen.getValueAt(0, 5).toString()) - (1);
            datosA.setCarne(Carne);

            //------------------------------------
        } else if (minic.combo.equals(2)) {
            int Pan = Integer.parseInt(tAlmacen.getValueAt(0, 1).toString()) - (1 * Integer.parseInt(cantidad));
            datosA.setPan(Pan);
            int Lechuga = Integer.parseInt(tAlmacen.getValueAt(0, 2).toString()) - (1 * Integer.parseInt(cantidad));
            datosA.setLechuga(Lechuga);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        juguetesA.setPelota((txtPelota.getText()));
        juguetesA.setMuñeca((txtMuñeca.getText()));
        juguetesA.setBarco((txtBarco.getText()));
        juguetesA.setCarrito((txtCarrito.getText()));
        juguetesA.setBom((txtBom.getText()));
        juguetesA.setCrayones((txtCrayones.getText()));
        juguetesA.setLego((txtLegos.getText()));
        actualizarAlmacenJ();
        actualizarJuguetes();
